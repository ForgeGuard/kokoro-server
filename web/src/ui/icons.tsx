...
/**
 * Inline, dependency-free icon set (no external icon package, no CDN).
 * All icons inherit `currentColor` and default to a 1.75 stroke.
 */
...
export const FileAudioIcon = (p: IconProps) => (
  <Icon {...p}>
    ...
    <path d="M14 2v6h6" />
    <path d="M9 14a2 2 0 1 0 0 4 2 2 0 0 0 0-4zM11 18v-5l3-1v4" />
  </Icon>
)
